...
def is_subtype_evidence(
    psi: Psi, evidence_1: EvidenceSignature, evidence_2: EvidenceSignature
) -> bool:
    ...
    """
    if is_subtype(
        psi, evidence_1.interval.lower_bound, evidence_2.interval.lower_bound
    ):
        if is_subtype(
            psi, evidence_1.interval.upper_bound, evidence_2.interval.upper_bound
        ):
